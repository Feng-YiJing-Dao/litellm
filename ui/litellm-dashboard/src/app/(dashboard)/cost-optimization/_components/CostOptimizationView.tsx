  ...
  return (
    <main className="w-full p-8">
      <Tabs defaultValue="usage" onValueChange={handleTabChange} className="gap-6">
        <PageHeader
          icon={<PiggyBank />}
          title={t("costs:optimization.title", "Cost Optimization")}
          subtitle={t(
            "costs:optimization.subtitle",
        ...
        >
          ...
          <p className="font-medium text-foreground">
            {t("costs:optimization.experimental_title", "This is an experimental dashboard")}
          </p>
          <p className="col-start-2 text-sm text-muted-foreground">
            {t(
              "costs:optimization.experimental_desc",
              "Track and monitor your cost optimization mechanisms and savings across all providers.",
            )}
          </p>
        </div>
