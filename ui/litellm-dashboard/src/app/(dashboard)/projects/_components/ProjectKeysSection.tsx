    ...
    <Card className="h-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t("projects:detail.keys_title", { defaultValue: "Keys" })}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="mb-3 flex items-center">
          <InputGroup className="max-w-[220px]">
            ...
            <InputGroupInput
              placeholder={t("projects:detail.filter_keys_placeholder", { defaultValue: "Filter by key name..." })}
              value={keyAlias}
            ...
            {keyAlias && (
              <InputGroupAddon align="inline-end">
                <InputGroupButton
                  size="icon-xs"
                  aria-label={t("projects:detail.clear_key_filter", { defaultValue: "Clear key filter" })}
                  onClick={() => setKeyAlias("")}
                >
                  <X />
                </InputGroupButton>
