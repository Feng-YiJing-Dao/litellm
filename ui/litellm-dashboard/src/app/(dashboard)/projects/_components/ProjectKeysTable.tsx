  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {t("projects:detail.no_keys_found", { defaultValue: "No keys found" })}
      </div>
      <div className="text-sm text-muted-foreground">
        {t("projects:detail.no_keys_desc", { defaultValue: "Keys created in this project will show up here." })}
      </div>
    </div>
  );
}
...
export function ProjectKeysTable({
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("projects:detail.loading_keys", { defaultValue: "Loading keys…" })}
