...
export default function ModelRetrySettingsPanel() {
  ...
  const handleSaveRetrySettings = () => {
    updateRetryPolicy.mutate(
      ...
      {
        onSuccess: () => {
          toast.success(t("models:retry_settings.save_success", "Retry settings saved successfully"));
        ...
        onError: () => {
          toast.fromError(t("models:retry_settings.save_error", "Failed to save retry settings"));
        },
      },
    );
  };
