  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {t("auto_routers.empty_title", { defaultValue: "No auto routers yet" })}
      </div>
      <div className="text-sm text-muted-foreground">
        {canModify
          ? t("auto_routers.empty_desc_can_modify", {
              defaultValue: "Create an auto router to pick the right model per request instead of pinning one.",
            })
          : t("auto_routers.empty_desc_readonly", {
...
export function AutoRoutersTable({
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("auto_routers.loading", { defaultValue: "Loading auto routers…" })}
