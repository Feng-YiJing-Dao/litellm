          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <Label htmlFor={serverHeaderToggleId} className="font-normal leading-normal">
                {t("connect_guide.limit_tools_prefix", {
                  defaultValue: "Limit tools to specific MCP servers or MCP groups by passing the ",
                })}
                <code>x-mcp-servers</code>
                {t("connect_guide.limit_tools_suffix", { defaultValue: " header" })}
              </Label>
            </div>
            {useServerHeader && (
              <Alert className="mt-2" variant="info">
                <Info />
                <AlertTitle>{t("connect_guide.two_options", { defaultValue: "Two Options" })}</AlertTitle>
                <AlertDescription>
                  <div>
                    <p>
                      <strong>{t("connect_guide.option_1", { defaultValue: "Option 1:" })}</strong>{" "}
                      {t("connect_guide.option_1_desc", { defaultValue: "Get a specific server:" })}{" "}
                      <code>"{serverName.replace(/\s+/g, "_")}"</code>
                    </p>
                    <p>
                      <strong>{t("connect_guide.option_2", { defaultValue: "Option 2:" })}</strong>{" "}
                      {t("connect_guide.option_2_desc", { defaultValue: "Get a group of MCPs:" })}{" "}
                      <code>"dev-group"</code>
                    </p>
                    <p className="mt-2 text-sm text-muted-foreground">
                      {t("connect_guide.mix_options_desc", { defaultValue: 'You can also mix both: "Server1,dev-group"' })}
                    </p>
                  </div>
                </AlertDescription>
              </Alert>
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-success/15 to-success/5 p-6 rounded-lg border border-success/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-success">
            {t("connect_guide.litellm_proxy_title", { defaultValue: "LiteLLM Proxy API Integration" })}
          </h4>
        </div>
        <span className="text-success">
          {t("connect_guide.litellm_proxy_desc", {
            defaultValue: "Connect to LiteLLM Proxy Responses API for seamless tool integration with multiple model providers",
          })}
        </span>
      </div>
      ...
      <div className="flex w-full flex-col gap-6">
        <FeatureCard
          ...
          title={t("connect_guide.virtual_key_setup", { defaultValue: "Virtual Key Setup" })}
          description={t("connect_guide.virtual_key_desc", {
        ...
        <FeatureCard
          ...
          title={t("connect_guide.mcp_server_info", { defaultValue: "MCP Server Information" })}
          description={t("connect_guide.mcp_server_info_desc", {
            defaultValue: "Connection details for your LiteLLM MCP server",
          })}
        >
          <CodeBlock
            title={t("connect_guide.server_url", { defaultValue: "Server URL" })}
        ...
        <FeatureCard
          ...
          title={t("connect_guide.implementation_example", { defaultValue: "Implementation Example" })}
          description={t("connect_guide.implementation_desc", {
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-info/15 to-info/5 p-6 rounded-lg border border-info/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-info">
            {t("connect_guide.openai_title", { defaultValue: "OpenAI Responses API Integration" })}
          </h4>
        </div>
        <span className="text-info">
          {t("connect_guide.openai_desc", {
      ...
      <div className="flex w-full flex-col gap-6">
        <FeatureCard
          ...
          title={t("connect_guide.api_key_setup", { defaultValue: "API Key Setup" })}
          description={t("connect_guide.api_key_desc", {
        ...
        >
          <div className="flex w-full flex-col gap-4">
            <div>
              <span>
                {t("connect_guide.get_api_key", { defaultValue: "Get your API key from the" })}{" "}
                <a
                ...
                >
                  {t("connect_guide.openai_platform", { defaultValue: "OpenAI platform" })} <ExternalLinkIcon size={12} />
                </a>
              </span>
            </div>
            <CodeBlock
      ...
      <div className="bg-linear-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-purple-100 dark:from-purple-950 dark:to-blue-950 dark:border-purple-900">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-purple-900 dark:text-purple-100">
            {t("connect_guide.cursor_title", { defaultValue: "Cursor IDE Integration" })}
          </h4>
        </div>
        <span className="text-purple-700 dark:text-purple-300">
          {t("connect_guide.cursor_desc", {
            defaultValue:
      ...
      <Card>
        <CardContent>
          <h5 className="mb-4 text-base font-semibold text-foreground">
            {t("connect_guide.setup_instructions", { defaultValue: "Setup Instructions" })}
          </h5>
          <div className="flex w-full flex-col gap-6">
            <StepCard step={1} title={t("connect_guide.cursor_step1_title", { defaultValue: "Open Cursor Settings" })}>
              <span className="text-muted-foreground">
                {t("connect_guide.cursor_step1_desc", {
                  mac: "⇧+⌘+J",
                  win: "Ctrl+Shift+J",
                  defaultValue: "Use the keyboard shortcut ⇧+⌘+J (Mac) or Ctrl+Shift+J (Windows/Linux)",
                })}
              </span>
            </StepCard>

            <StepCard step={2} title={t("connect_guide.cursor_step2_title", { defaultValue: "Navigate to MCP Tools" })}>
              <span className="text-muted-foreground">
                {t("connect_guide.cursor_step2_desc", {
                  defaultValue: 'Go to the "MCP Tools" tab and click "New MCP Server"',
                })}
              </span>
            </StepCard>

            <StepCard step={3} title={t("connect_guide.cursor_step3_title", { defaultValue: "Add Configuration" })}>
              <span className="mb-3 text-muted-foreground">
                {t("connect_guide.cursor_step3_desc", {
                  saveMac: "Cmd+S",
                  saveWin: "Ctrl+S",
                  defaultValue:
              ...
              <FeatureCard
                ...
                title={t("connect_guide.configuration", { defaultValue: "Configuration" })}
                description={t("connect_guide.cursor_config_desc", { defaultValue: "Cursor MCP configuration" })}
                serverName="Zapier Gmail"
                accessGroups={["dev-group"]}
              >
                <CodeBlock
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-success/15 to-success/5 p-6 rounded-lg border border-success/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-success">
            {t("connect_guide.http_title", { defaultValue: "Streamable HTTP Transport" })}
          </h4>
        </div>
        <span className="text-success">
          {t("connect_guide.http_desc", {
            defaultValue:
      ...
      <FeatureCard
        ...
        title={t("connect_guide.universal_connection", { defaultValue: "Universal MCP Connection" })}
        description={t("connect_guide.universal_desc", {
      ...
      >
        <div className="flex w-full flex-col gap-4">
          <div>
            <span>
              {t("connect_guide.universal_hint", {
                defaultValue:
          ...
          />
          <CodeBlock
            title={t("connect_guide.headers_config", { defaultValue: "Headers Configuration" })}
            code={JSON.stringify(
              {
                "x-litellm-api-key": "Bearer YOUR_LITELLM_API_KEY",
              },
          ...
          <div className="mt-4">
            ...
            >
              ...
              {t("connect_guide.learn_more_transports", { defaultValue: "Learn more about MCP transports" })}
            </Button>
          </div>
        </div>
      </FeatureCard>
      ...
      <div className="flex w-full flex-col gap-6">
        <div>
          <h2 className="text-3xl font-bold text-foreground mb-3">
            {t("connect_guide.title", { defaultValue: "Connect to your MCP client" })}
          </h2>
          <p className="text-lg text-muted-foreground">
            {t("connect_guide.subtitle", {
              defaultValue:
            ...
            <div className="flex rounded-lg bg-muted p-1">
              <TabsTrigger value="openai" className="flex-none px-6 py-3">
                <span className="flex items-center gap-2 font-medium">
                  <Code size={18} />
                  {t("connect_guide.tab_openai", { defaultValue: "OpenAI API" })}
                </span>
              </TabsTrigger>
              <TabsTrigger value="litellm" className="flex-none px-6 py-3">
                <span className="flex items-center gap-2 font-medium">
                  <Zap size={18} />
                  {t("connect_guide.tab_litellm_proxy", { defaultValue: "LiteLLM Proxy" })}
                </span>
              </TabsTrigger>
              <TabsTrigger value="cursor" className="flex-none px-6 py-3">
                <span className="flex items-center gap-2 font-medium">
                  <Terminal size={18} />
                  {t("connect_guide.tab_cursor", { defaultValue: "Cursor" })}
                </span>
              </TabsTrigger>
              <TabsTrigger value="http" className="flex-none px-6 py-3">
                <span className="flex items-center gap-2 font-medium">
                  <Globe size={18} />
                  {t("connect_guide.tab_http", { defaultValue: "Streamable HTTP" })}
                </span>
              </TabsTrigger>
            </div>
          </TabsList>
