      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <Checkbox
            ...
            aria-label={t("playground:sync_settings_across_models", { defaultValue: "Sync Settings Across Models" })}
          />
          <label htmlFor={syncId} className="cursor-pointer text-xs font-medium">
            {t("playground:sync_settings_across_models", { defaultValue: "Sync Settings Across Models" })}
          </label>
        </div>
        ...
        <div>
          <h4 className="text-xs font-semibold text-foreground mb-1.5 uppercase tracking-wide">
            {t("playground:general_settings", { defaultValue: "General Settings" })}
          </h4>
          <div className="space-y-2">
            <div>
              <label className="text-xs font-medium text-muted-foreground block mb-0.5">
                {t("playground:tags", { defaultValue: "Tags" })}
              </label>
              <TagSelector
            ...
            <div>
              <label className="text-xs font-medium text-muted-foreground block mb-0.5">
                {t("playground:vector_stores", { defaultValue: "Vector Stores" })}
              </label>
              <VectorStoreSelector
            ...
            <div>
              <label className="text-xs font-medium text-muted-foreground block mb-0.5">
                {t("playground:guardrails", { defaultValue: "Guardrails" })}
              </label>
              <GuardrailSelector
        ...
        <div>
          <h4 className="text-xs font-semibold text-foreground mb-1.5 uppercase tracking-wide">
            {t("playground:advanced_params", { defaultValue: "Advanced Settings" })}
          </h4>
          <div className="space-y-2">
            <div className="flex items-center gap-2 pb-1">
              <Checkbox
                ...
                aria-label={t("playground:use_advanced_params", { defaultValue: "Use Advanced Parameters" })}
              />
              <label htmlFor={advancedParamsId} className="cursor-pointer text-sm font-medium">
                {t("playground:use_advanced_params", { defaultValue: "Use Advanced Parameters" })}
              </label>
            </div>
