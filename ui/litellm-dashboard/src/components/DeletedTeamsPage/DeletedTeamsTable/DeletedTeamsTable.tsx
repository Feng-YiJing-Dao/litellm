...
function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">{t("teams:deleted_teams.no_deleted_teams", "No deleted teams found")}</div>
      <div className="text-sm text-muted-foreground">{t("teams:deleted_teams.no_deleted_teams_desc", "Teams deleted from this proxy will show up here.")}</div>
    </div>
  );
}
...
export function DeletedTeamsTable({
  ...
  return (
    <DataTable
      ...
      rowCount={rowCount}
      isLoading={isLoading}
      loadingMessage={t("teams:deleted_teams.loading", "Loading deleted teams…")}
