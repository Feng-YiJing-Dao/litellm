...
export const getRequestLogsTableColumns = ({
...
}: RequestLogsTableColumnsDeps): ColumnDef<LogEntry>[] => [
  {
    ...
    header: ({ column }) => <DataTableSortHeader column={column} title={t("logs:col_time", "Time")} variant="dropdown-tristate" />,
    size: 200,
    enableSorting: true,
  ...
  {
    id: "status",
    header: t("logs:col_status", "Status"),
    size: 100,
    enableSorting: false,
    meta: { skeleton: "badge" },
    cell: ({ row }) => {
      ...
      return (
        <StatusBadge
          ...
          label={isSuccess ? t("logs:status_success", "Success") : t("logs:status_failure", "Failure")}
        />
      );
    },
  },
  {
    ...
    header: t("logs:col_session_id", "Session ID"),
    size: 120,
    enableSorting: false,
  ...
  },
  {
    ...
    header: t("logs:col_request_id", "Request ID"),
    enableSorting: false,
    cell: ({ row }) => {
      const log = row.original;
      ...
      if (batchId) {
        return (
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-muted-foreground">{t("logs:batch_cost", "batch cost")}</span>
          </div>
        );
      }
  ...
  },
  {
    id: "spend",
    accessorKey: "spend",
    header: ({ column }) => <DataTableSortHeader column={column} title={t("logs:col_cost", "Cost")} variant="dropdown-tristate" />,
    size: 110,
    enableSorting: true,
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex flex-col items-end">
          ...
          {isMultiCallSession && (
            <span className="text-[10px] text-muted-foreground">{t("logs:session_total", "session total")}</span>
          )}
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableSortHeader column={column} title={t("logs:col_duration", "Duration (s)")} variant="dropdown-tristate" />,
    enableSorting: true,
    meta: { numeric: true },
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableSortHeader column={column} title={t("logs:col_ttft", "TTFT (s)")} variant="dropdown-tristate" />,
    enableSorting: true,
    meta: { numeric: true },
    cell: ({ row }) => {
      const log = row.original;
  ...
  {
    id: "team_alias",
    header: t("logs:col_team_name", "Team Name"),
    size: 150,
    enableSorting: false,
  ...
  {
    id: "key_hash",
    header: t("logs:col_key_hash", "Key Hash"),
    size: 110,
    enableSorting: false,
    cell: ({ row }) => (
  ...
  {
    id: "key_alias",
    header: t("logs:col_key_alias", "Key Alias"),
    size: 150,
    enableSorting: false,
  ...
  },
  {
    id: "model",
    accessorKey: "model",
    header: ({ column }) => <DataTableSortHeader column={column} title={t("logs:col_model", "Model")} variant="dropdown-tristate" />,
    size: 200,
    enableSorting: true,
    cell: ({ row }) => {
      const log = row.original;
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableSortHeader column={column} title={t("logs:col_tokens", "Tokens")} variant="dropdown-tristate" />,
    size: 140,
    enableSorting: true,
    meta: { numeric: true },
    cell: ({ row }) => {
  ...
  },
  {
    id: "user",
    accessorKey: "user",
    header: t("logs:col_internal_user", "Internal User"),
    size: 150,
    enableSorting: false,
  ...
  },
  {
    ...
    header: t("logs:col_end_user", "End User"),
    size: 140,
    enableSorting: false,
