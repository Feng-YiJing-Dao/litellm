      ...
      <Collapsible open={open} onOpenChange={setOpen}>
        <CollapsibleTrigger className="flex w-full items-center gap-3 px-4 py-3 text-left transition-colors hover:bg-muted">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <h3 className="text-lg font-medium text-foreground">{t("logs:tools_section.title", "Tools")}</h3>
            <span className="text-sm text-muted-foreground">
              {t("logs:tools_section.summary", `${totalTools} provided, ${calledTools} called`, {
                total: totalTools,
                called: calledTools,
              })}
            </span>
