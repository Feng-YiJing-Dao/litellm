  ...
  return (
    <div>
      ...
      {parameterRows.length > 0 && (
        <div>
          <span className="mb-2 block text-xs text-muted-foreground">{t("logs:tools_section.parameters", "Parameters")}</span>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>{t("logs:tools_section.parameter", "Parameter")}</TableHead>
                <TableHead>{t("logs:tools_section.type", "Type")}</TableHead>
                <TableHead>{t("logs:tools_section.description", "Description")}</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
      ...
      {tool.called && tool.callData && (
        <div className="mt-4">
          <span className="mb-2 block text-xs text-muted-foreground">{t("logs:tools_section.called_with", "Called With")}</span>
