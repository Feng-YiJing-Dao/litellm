            ...
            <div className="flex items-center gap-2 text-foreground">
              ...
              <div>
                <DialogTitle className="text-lg font-bold m-0">
                  {t("models:configure_fallbacks", { defaultValue: "Configure Model Fallbacks" })}
                </DialogTitle>
                <p className="text-sm text-muted-foreground font-normal m-0">
                  {t("models:manage_fallback_chains_desc", { defaultValue: "Manage multiple fallback chains for different models (up to 5 groups at a time)" })}
                </p>
              </div>
            </div>
          </div>
