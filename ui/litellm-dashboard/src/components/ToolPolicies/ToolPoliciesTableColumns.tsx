  ...
  return [
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.discovered", { defaultValue: "Discovered" })}
        />
      ),
      size: 170,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.tool_name", { defaultValue: "Tool Name" })}
        />
      ),
      minSize: 200,
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.input_policy", { defaultValue: "Input Policy" })}
        />
      ),
      size: 140,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.output_policy", { defaultValue: "Output Policy" })}
        />
      ),
      size: 140,
      filterFn: "equalsString",
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.calls", { defaultValue: "# Calls" })}
        />
      ),
      size: 100,
      enableGlobalFilter: false,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.team_name", { defaultValue: "Team Name" })}
        />
      ),
      size: 160,
      filterFn: "equalsString",
    ...
    },
    {
      ...
      header: tr("policies.table.key_hash", { defaultValue: "Key Hash" }),
      size: 150,
      enableSorting: false,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={tr("policies.table.key_name", { defaultValue: "Key Name" })}
        />
      ),
      size: 150,
      filterFn: "equalsString",
    ...
    },
    {
      ...
      header: tr("policies.table.user_agent", { defaultValue: "User Agent" }),
      size: 180,
      enableSorting: false,
      enableGlobalFilter: false,
      cell: ({ row }) => (
