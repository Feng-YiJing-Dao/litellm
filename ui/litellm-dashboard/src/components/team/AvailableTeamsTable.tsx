  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {t("teams:available_teams.no_available_teams", "No available teams to join")}
      </div>
      <div className="text-sm text-muted-foreground">
        {t("teams:available_teams.docs_hint", "See how to set available teams")}{" "}
        <a
...
const AvailableTeamsTable: React.FC<AvailableTeamsTableProps> = ({ teams, isLoading, onJoinTeam }) => {
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("teams:available_teams.loading", "Loading available teams…")}
