  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {t("models:credentials.no_credentials", "No credentials configured")}
      </div>
      <div className="text-sm text-muted-foreground">
        {t("models:credentials.no_credentials_desc", "Add a credential to connect an AI provider.")}
      </div>
    </div>
  );
}
...
const CredentialsTable: React.FC<CredentialsTableProps> = ({
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("models:credentials.loading", "Loading credentials…")}
