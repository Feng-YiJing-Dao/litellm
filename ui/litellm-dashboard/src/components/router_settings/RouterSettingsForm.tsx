    ...
    <div className="w-full space-y-8 py-2">
      ...
      <div className="space-y-6">
        <div className="max-w-3xl">
          <h3 className="text-sm font-medium text-foreground">{t("router:routing_settings", { defaultValue: "Routing Settings" })}</h3>
          <p className="text-xs text-muted-foreground mt-1">{t("router:routing_settings_desc", { defaultValue: "Configure how requests are routed to deployments" })}</p>
        </div>
